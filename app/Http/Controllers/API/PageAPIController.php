...
class PageAPIController extends AppBaseController
{
    ...
    public function getAboutUs($lang = en)
    {
    	$page = null;
    	
    	if($lang == "en")
    	{
    		$page = Page::where('id', Page::$PAGE_ABOUT_US_ID_EN)->first();
    	}
    	else 
    	{
    		$page = Page::where('id', Page::$PAGE_ABOUT_US_ID_AR)->first();
    	}
    ...
    public function getPrivacyPolicy($lang = en)
    {
    	$page = null;
    	
    	if($lang == "en")
    	{
    		$page = Page::where('id', Page::$PAGE_PRIVACY_POLICY_ID_EN)->first();
    	}
    	else
    	{
    		$page = Page::where('id', Page::$PAGE_PRIVACY_POLICY_ID_AR)->first();
    	}
    ...
    public function getFAQ($lang = en)
    {
    	...
    	if($lang == "en")
    	{
    		$page = Page::where('id', Page::$PAGE_FAQ_ID_EN)->first();
    	}
    	else
    	{
    		$page = Page::where('id', Page::$PAGE_FAQ_ID_AR)->first();
    	}
